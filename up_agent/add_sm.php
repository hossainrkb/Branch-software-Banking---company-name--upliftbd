        ...
        $m_operator_info = get_mobile_operator_info_by_code($mo_code);
         if($m_operator_info){	
            if(check_employee_info_by_contact_no($e_contact)){
                ...
                $e_ref_id='0';
                $e_type='1';//Sales Manager   
                $password = generatePIN(8);
                $e_password = md5($password);
                $e_branch_id=$branch_id;
                $e_userid='SM'.$e_type.generatePIN(3).$e_branch_id;
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h2><b><i class="fa fa-user"></i> <?php echo $pageName; ?> (SM)</b></h2> 
                    </div>
                </div>
                 <!-- /. ROW  -->
                 <hr />
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td colspan="2" class="text-center">
                                                                        <a href="add_sm.php"><b><i class="fa fa-reply-all"></i> Add Another</b></a>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                            <tfoot>
