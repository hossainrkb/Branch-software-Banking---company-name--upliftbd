...
if(isset($_POST['password'])){
    ...
    $user_tpin = $branch_info['br_tpin'];
    
if($u_password==$user_password){
         $updateStatus .= "<b>Your Branch T-Pin is : [ $user_tpin ]</b>";
 }else{
     $updateStatus .='Password Not Match.';
 }
}
?>
<!DOCTYPE html>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h2><b><i class="fa fa-lock"></i> View Branch T-Pin</b></h2> 
                    </div>
                </div>
                 <!-- /. ROW  -->
                 <hr />
                                        ...
                                        <table class="table table-condensed text-left">
                                            <thead>
                                                <tr class="btn-danger text-center">
                                                    <td colspan="3"><h3><b>Enter Your Information Below</b></h3></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><b><input class="form-control" type="password" name="password" placeholder="Enter Your Account Password" autocomplete="off" autofocus="off" required="" /></b></td>
                                                    <td class="text-left">
