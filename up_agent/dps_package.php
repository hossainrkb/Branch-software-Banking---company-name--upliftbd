                                ...
                                <table class="table table-bordered table-condensed table-striped table-hover text-center" id="dataTables-example">
                                    <thead>
                                        <tr class="btn-danger text-center">
                                            ...
                                            <td><span class="btn"><b>Profit</b></span></td>
                                    ...
                                    <tbody>
                                        <?php 
                                        $i=1;
                                        $dps_package= get_all_dps_packages();
                                        foreach ($dps_package as $d_pack){
                                             ?>
                                        <tr>
                                            <td><h5><b><?php echo $i; ?></b></h5></td>
                                            <td><h5><b><?php echo $d_pack['dpi_month']." Month"; ?></b></h5></td>
                                            <td><h5><b><?php echo "(".$d_pack['dpi_min_amount']." - ".$d_pack['dpi_max_amount'].")" ."  BDT"; ?></b></h5></td>
                                            <td><h5><b><?php echo $d_pack['dpi_profit']."%"; ?></b></h5></td>
                                            <td><h5><b><?php if($d_pack['dpi_status']==1){ echo '<span class="label label-success">Active</span>';} else{ echo '<span class="label label-danger">Deactive</span>'; } ?></b></h5></td>
                                        </tr>
                                        <?php $i++; } ?>
                                    </tbody>
                                    <tfoot>
