    ...
    if(check_user_verify($sponsor_id)){
         $updateStatus .= "<b style='color: red;'>This member isn't verified.</b><a class='btn btn-danger' href='v_member.php'><b><i class='fa fa-recycle'></i> Try Again</b></a>";
            ...
            if($results){
              ...
              mysql_query("UPDATE tbl_users_info SET u_balance='".$total_minus."' WHERE u_id='".$u_sponsor_id."'");
              ...
              foreach ($all_users as $user) {
                  ...
                  mysql_query("UPDATE tbl_users_info SET u_balance='".$sponsor_commission."' WHERE u_id='".$sponsor_primary_key."'");
     ...
     $updateStatus .= "<b style='color: red;'> Failed.</b><a class='btn btn-danger' href='do_fdr.php'><b><i class='fa fa-recycle'></i> Try Again</b></a>";
        ...
        $updateStatus .= "<b style='color: red;'>Branch T-Pin Not Match.</b><a class='btn btn-danger' href='do_fdr.php'><b><i class='fa fa-recycle'></i> Try Again</b></a>";
    }
}
?>
<!DOCTYPE html>
                                                            ...
                                                            <table  class=" table table-condensed table-bordered text-center">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-left"><b><?php echo $fdr_o_amount.".00 "?> BDT</b></td>
