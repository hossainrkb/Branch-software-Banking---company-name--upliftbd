    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h2><b><i class="fa fa-list"></i> Member Deposit History</b></h2>
                    </div>
                </div>
                 <!-- /. ROW  -->
                 <hr/>
                                ...
                                <table class="table table-bordered table-condensed table-striped table-hover text-center" id="dataTables-example">
                                    <thead>
                                        <tr class="btn-danger text-center">
                                            ...
                                            <td><span class="btn"><b>Txn Date</b></span></td>
                                    ...
                                    <tbody>
                                        <?php 
                                        $i=1;
                                        $deposit_history= get_all_deposit_history($branch_id);
                                        foreach ($deposit_history as $history){
                                            $member_info = get_member_info_by_id($history['dep_user']);
                                            $get_dep_cat= get_deposit_category_info_by_id($history['dep_category']);
                                        ?>
                                        <tr>
                                            <td><b><?php echo $i; ?>.</b></td>
                                            <td><b><?php echo $history['dep_date'];?></b></td>
                                            <td><a class="btn" href="member_info.php?m_id=<?php echo $member_info['u_id']; ?>" target="_blank"><b><?php echo $member_info['u_userid']; ?></b></a></td>
                                            <td class="text-left"><b><?php echo $member_info['u_name']; ?></b></td>
                                            <td class="text-left"><b><?php echo $get_dep_cat['dc_name']; ?></b></td>
                                            <td><b><?php echo $history['dep_amount']; ?></b></td>
                                            </tr>
                                        <?php $i++; } ?>
                                    </tbody>
                                    <tfoot>
