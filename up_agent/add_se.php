        ...
        $m_operator_info = get_mobile_operator_info_by_code($mo_code);
         if($m_operator_info){	
            if(check_employee_info_by_contact_no($e_contact)){
                ...
                $e_ref_id='1';
                $e_type='2';//Sales Executive   
                $password = generatePIN(8);
                $e_password = md5($password);
                $e_branch_id=$branch_id;
                $e_userid='SE'.$e_branch_id.$e_type.$e_ref_id.generatePIN(2).generatePIN(1);
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h2><b><i class="fa fa-user"></i> <?php echo $pageName; ?> (SE)</b></h2> 
                    </div>
                </div>
                 <!-- /. ROW  -->
                 <hr />
                                    ...
                                    <form id="form" action="" method="post" >
                                        <table class="table table-condensed text-left table-hover table-striped">
                                            ...
                                            <tbody>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td colspan="2" class="text-center">
                                                                        <a href="add_se.php"><b><i class="fa fa-reply-all"></i> Add Another</b></a>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                            <tfoot>
                                                ...
                                                <?php }else{ ?>
                                                <tr>
                                                    <td class="text-right text-info"><h5><b>Employee Name :</b></h5></td>
                                                    <td colspan="3"><b><input class="form-control" type="text" name="ename" placeholder="Enter Employee Name" autocomplete="off" autofocus="off" required="" /></b></td>
                                                </tr>
                                                <tr>
