    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h2><b><i class="fa fa-history"></i> Expense Details</b></h2>
                    </div>
                </div>
            <!-- /. ROW  -->
            <hr />
                        ...
                        <div class="panel-body">
                            <table class="table table-condensed table-bordered table-striped table-hover text-center">
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        <td colspan="4">
                                           <a class="btn pull-left" href="expense_history.php"><b><i class="fa fa-reply-all"></i> Back</b></a>
                                ...
                                <?php }else{ ?>
                                    ...
                                    <tr>
                                        <td colspan="4">
                                           <a class="btn" href="expense_history.php"><b><i class="fa fa-reply-all"></i> Back</b></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                                </tfoot>
